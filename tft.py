...
POSTGRES_CONN_STR = "postgresql://admin:Admin123456!@34.122.18.117:5432/cloud_optimizer"
BATCH_SIZE = 64
MAX_EPOCHS = 20
...
def train_model(training, validation):
    ...
    tft = TemporalFusionTransformer.from_dataset(
        ...
        output_size=7,  # 7 quantiles output
        loss=QuantileLoss(),
    ...
    trainer.save_checkpoint("tft_cost_forecast.ckpt")
